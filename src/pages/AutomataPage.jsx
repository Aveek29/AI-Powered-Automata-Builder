    ...
    <div className="max-w-6xl mx-auto p-3 md:p-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        <div className="space-y-4 md:space-y-6">
          ...
          <div className={`space-y-4 md:space-y-6 ${mobileTab !== "builder" ? "hidden lg:block" : ""}`}>
            {automata && (
            ...
            {automata && (
              <div className="card p-4 md:p-5">
                ...
                <GraphView
                  ...
                  onStateClick={(stateId) => setCurrentState(stateId)}
                />
              </div>
            )}
            ...
            {automata && (
              <Simulator
                automata={automata}
                onStateChange={(stateId) => setCurrentState(stateId)}
              />
            )}
          </div>

          <div className={`space-y-4 md:space-y-6 ${mobileTab !== "tutor" ? "hidden lg:block" : ""}`}>
            {automata && (
          ...
          <div className={`${mobileTab !== "batch" ? "hidden lg:block" : ""}`}>
            {automata && (
              <BatchTestingPanel automata={automata} />
            )}
          </div>
        </div>
